МШП - практическая работа по разработке дашборда по основным метрикам интернет магазина, разработанного на Tilda. Показатели работы сайта загружаются в метрику, после загружаются через сервис кафку в кликхаус. Далее данные из кликхауса будут отображаться в дашборде.
